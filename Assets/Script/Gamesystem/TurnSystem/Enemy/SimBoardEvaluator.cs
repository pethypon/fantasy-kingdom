...
public static class SimBoardEvaluator
{
    ...
    // 駒価値差 → SimCombatEval に委譲
    static float EvalMaterial(SimBoardState board) => SimCombatEval.EvalMaterial(board);
    ...
    // 脅威と反撃 → SimCombatEval に委譲
    static float EvalThreat(SimBoardState board) => SimCombatEval.EvalThreat(board);
    ...
    // 連携攻撃 → SimCombatEval に委譲
    static float EvalCoordination(SimBoardState board) => SimCombatEval.EvalCoordination(board);
