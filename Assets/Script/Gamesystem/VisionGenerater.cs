...
public class VisionGenerater : MonoBehaviour
{
    ...
    /// <summary>
    /// StatusのVisionCellを初期化・計算し、結果をtargetSetにマージする
    /// </summary>
    ...
    /// <summary>
    /// Crystal用：上方からのRaycastで地表の高さを取得し視界セルに追加する
    /// </summary>
    ...
    /// showOnExploard=false: 未視界かつ未探索のとき表示（完全な霧）
    /// showOnExploard=true:  未視界かつ探索済みのとき表示（探索済み霧）
    /// </summary>
    ...
    {
        //PlayerVisionBoxとPlayerExploardのXZだけをとるための箱を作る
