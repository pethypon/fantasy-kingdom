...
public class GameGenerater : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // ���� UI�\�z ����������������������������������������������������������������������������������������������������������
        if (_UIBuilder == null)
            _UIBuilder = GetComponent<UIBuilder>();
        if (_UIBuilder == null)
            _UIBuilder = gameObject.AddComponent<UIBuilder>();
        _UIBuilder.BuildUI(_TurnGenerater, _APSystem, factionState);
        _TurnGenerater.unitPanelUI = _UIBuilder.unitPanelUI;
